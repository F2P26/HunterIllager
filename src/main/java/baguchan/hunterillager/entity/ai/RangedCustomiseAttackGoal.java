...
public class RangedCustomiseAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
    ...
    public RangedCustomiseAttackGoal(T mob, double moveSpeedAmpIn, int attackCooldownIn, float maxAttackDistanceIn) {
        this.entity = mob;
    ...
    protected boolean isBowInMainhand() {
        ...
        return main.getItem() instanceof BowItem || off.getItem() instanceof BowItem || main.getItem() instanceof BoomerangItem || off.getItem() instanceof BoomerangItem;
    }
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.entity.isHandActive()) {
                ...
                if (!main.isEmpty()) {
                    this.entity.setActiveHand(ProjectileHelper.getHandWith(this.entity, main.getItem()));
                } else if (!off.isEmpty()) {
                    this.entity.setActiveHand(ProjectileHelper.getHandWith(this.entity, off.getItem()));
                }
            }
